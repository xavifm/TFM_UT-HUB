...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMinion_GetCrowns_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMinion, nullptr, "GetCrowns", Z_Construct_UFunction_AMinion_GetCrowns_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_GetCrowns_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMinion_GetCrowns_Statics::Minion_eventGetCrowns_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_GetCrowns_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMinion_GetCrowns_Statics::Function_MetaDataParams)},  };
...
void AMinion::MoveCrownVerticalAxis(float _position)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AMinion_MoveCrownVerticalAxis);
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMinion_MoveToSquare_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMinion, nullptr, "MoveToSquare", Z_Construct_UFunction_AMinion_MoveToSquare_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_MoveToSquare_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMinion_MoveToSquare_Statics::Minion_eventMoveToSquare_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_MoveToSquare_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMinion_MoveToSquare_Statics::Function_MetaDataParams)},  };
...
void AMinion::SetMinionAnimation(EMinionState _animation)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AMinion_SetMinionAnimation);
	ProcessEvent(Func,&Parms);
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMinion_SetMinionAnimation_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMinion, nullptr, "SetMinionAnimation", Z_Construct_UFunction_AMinion_SetMinionAnimation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SetMinionAnimation_Statics::PropPointers), sizeof(Minion_eventSetMinionAnimation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SetMinionAnimation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMinion_SetMinionAnimation_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Class AMinion Function SetMinionCoinsSize **************************************
struct Minion_eventSetMinionCoinsSize_Parms
{
	float _size;
};
static FName NAME_AMinion_SetMinionCoinsSize = FName(TEXT("SetMinionCoinsSize"));
void AMinion::SetMinionCoinsSize(float _size)
{
	Minion_eventSetMinionCoinsSize_Parms Parms;
	Parms._size=_size;
	UFunction* Func = FindFunctionChecked(NAME_AMinion_SetMinionCoinsSize);
	ProcessEvent(Func,&Parms);
}
struct Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Minion UI" },
...
#endif // WITH_METADATA
	static const UECodeGen_Private::FFloatPropertyParams NewProp__size;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::NewProp__size = { "_size", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Minion_eventSetMinionCoinsSize_Parms, _size), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::NewProp__size,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMinion, nullptr, "SetMinionCoinsSize", Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::PropPointers), sizeof(Minion_eventSetMinionCoinsSize_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Minion_eventSetMinionCoinsSize_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AMinion_SetMinionCoinsSize()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMinion_SetMinionCoinsSize_Statics::FuncParams);
	}
	return ReturnFunction;
}
// ********** End Class AMinion Function SetMinionCoinsSize ****************************************
...
void AMinion::ShowMinionCoinsFeedback(int32 _quantity)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AMinion_ShowMinionCoinsFeedback);
	ProcessEvent(Func,&Parms);
}
...
void AMinion::ShowMinionCrownsFeedback(int32 _quantity)
{
	...
	Parms._quantity=_quantity;
	UFunction* Func = FindFunctionChecked(NAME_AMinion_ShowMinionCrownsFeedback);
	ProcessEvent(Func,&Parms);
}
...
void AMinion::SwitchCrownVisibility(bool _enabled)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AMinion_SwitchCrownVisibility);
	ProcessEvent(Func,&Parms);
}
...
void AMinion::SwitchMinionVisibility(bool _visible)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AMinion_SwitchMinionVisibility);
	ProcessEvent(Func,&Parms);
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMinion_SwitchMinionVisibility_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMinion, nullptr, "SwitchMinionVisibility", Z_Construct_UFunction_AMinion_SwitchMinionVisibility_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SwitchMinionVisibility_Statics::PropPointers), sizeof(Minion_eventSwitchMinionVisibility_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SwitchMinionVisibility_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMinion_SwitchMinionVisibility_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Class AMinion Function SwitchSelectArrowVisibility *****************************
struct Minion_eventSwitchSelectArrowVisibility_Parms
{
	bool _visible;
};
static FName NAME_AMinion_SwitchSelectArrowVisibility = FName(TEXT("SwitchSelectArrowVisibility"));
void AMinion::SwitchSelectArrowVisibility(bool _visible)
{
	Minion_eventSwitchSelectArrowVisibility_Parms Parms;
	Parms._visible=_visible ? true : false;
	UFunction* Func = FindFunctionChecked(NAME_AMinion_SwitchSelectArrowVisibility);
	ProcessEvent(Func,&Parms);
}
struct Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Minion Functions" },
...
void Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::NewProp__visible_SetBit(void* Obj)
{
	((Minion_eventSwitchSelectArrowVisibility_Parms*)Obj)->_visible = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::NewProp__visible = { "_visible", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(Minion_eventSwitchSelectArrowVisibility_Parms), &Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::NewProp__visible_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::NewProp__visible,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMinion, nullptr, "SwitchSelectArrowVisibility", Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::PropPointers), sizeof(Minion_eventSwitchSelectArrowVisibility_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Minion_eventSwitchSelectArrowVisibility_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility_Statics::FuncParams);
	}
	return ReturnFunction;
}
// ********** End Class AMinion Function SwitchSelectArrowVisibility *******************************
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMinion_UpdateCoins_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMinion, nullptr, "UpdateCoins", Z_Construct_UFunction_AMinion_UpdateCoins_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_UpdateCoins_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMinion_UpdateCoins_Statics::Minion_eventUpdateCoins_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_UpdateCoins_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMinion_UpdateCoins_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMinion_UpdateCrowns_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMinion, nullptr, "UpdateCrowns", Z_Construct_UFunction_AMinion_UpdateCrowns_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_UpdateCrowns_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMinion_UpdateCrowns_Statics::Minion_eventUpdateCrowns_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMinion_UpdateCrowns_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMinion_UpdateCrowns_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_AMinion;
UClass* AMinion::GetPrivateStaticClass()
{
	using TClass = AMinion;
	if (!Z_Registration_Info_UClass_AMinion.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("Minion"),
			Z_Registration_Info_UClass_AMinion.InnerSingleton,
			StaticRegisterNativesAMinion,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AMinion.InnerSingleton;
}
UClass* Z_Construct_UClass_AMinion_NoRegister()
{
	return AMinion::GetPrivateStaticClass();
}
struct Z_Construct_UClass_AMinion_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMinion_DelayedPlayerCheck, "DelayedPlayerCheck" }, // 2724236969
		{ &Z_Construct_UFunction_AMinion_GetCoins, "GetCoins" }, // 3670118748
		{ &Z_Construct_UFunction_AMinion_GetCrowns, "GetCrowns" }, // 3601013880
		{ &Z_Construct_UFunction_AMinion_GetMinionsMovements, "GetMinionsMovements" }, // 708335853
		{ &Z_Construct_UFunction_AMinion_GetNextSquare, "GetNextSquare" }, // 2882550560
		{ &Z_Construct_UFunction_AMinion_MoveCrownVerticalAxis, "MoveCrownVerticalAxis" }, // 541856330
		...
		{ &Z_Construct_UFunction_AMinion_SwitchMinionVisibility, "SwitchMinionVisibility" }, // 4094313539
		{ &Z_Construct_UFunction_AMinion_SwitchSelectArrowVisibility, "SwitchSelectArrowVisibility" }, // 1209575164
		{ &Z_Construct_UFunction_AMinion_UpdateCoins, "UpdateCoins" }, // 4063858585
		{ &Z_Construct_UFunction_AMinion_UpdateCrowns, "UpdateCrowns" }, // 4136914476
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Minion_Minion_h__Script_PartyJungle_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Minion_Minion_h__Script_PartyJungle_2719710418(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Minion_Minion_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Minion_Minion_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Minion_Minion_h__Script_PartyJungle_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Minion_Minion_h__Script_PartyJungle_Statics::EnumInfo));
// ********** End Registration *********************************************************************
