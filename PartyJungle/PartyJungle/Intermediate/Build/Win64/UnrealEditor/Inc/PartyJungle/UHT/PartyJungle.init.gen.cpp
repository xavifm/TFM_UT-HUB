...
void EmptyLinkFunctionForGeneratedCodePartyJungle_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_PartyJungle()
	{
		if (!Z_Registration_Info_UPackage__Script_PartyJungle.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_PartyJungle_Event_ProgressBarPercentChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_PartyJungle_Event_SceneChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_PartyJungle_Event_UpdateWidgets__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_PartyJungle(Z_Construct_UPackage__Script_PartyJungle, TEXT("/Script/PartyJungle"), Z_Registration_Info_UPackage__Script_PartyJungle, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x38014A13, 0x434EBFF4));
