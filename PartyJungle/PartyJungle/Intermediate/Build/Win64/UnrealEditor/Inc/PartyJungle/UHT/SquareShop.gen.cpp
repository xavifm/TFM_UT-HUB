...
// ********** Begin Class ASquareShop Function SetCurrentWheelPosition *****************************
struct SquareShop_eventSetCurrentWheelPosition_Parms
{
	int32 _position;
};
static FName NAME_ASquareShop_SetCurrentWheelPosition = FName(TEXT("SetCurrentWheelPosition"));
void ASquareShop::SetCurrentWheelPosition(int32 _position)
{
	SquareShop_eventSetCurrentWheelPosition_Parms Parms;
	Parms._position=_position;
	UFunction* Func = FindFunctionChecked(NAME_ASquareShop_SetCurrentWheelPosition);
	ProcessEvent(Func,&Parms);
}
struct Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Map/SquareShop.h" },
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::NewProp__position = { "_position", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SquareShop_eventSetCurrentWheelPosition_Parms, _position), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::NewProp__position,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_ASquareShop, nullptr, "SetCurrentWheelPosition", Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::PropPointers), sizeof(SquareShop_eventSetCurrentWheelPosition_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(SquareShop_eventSetCurrentWheelPosition_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition_Statics::FuncParams);
	}
	return ReturnFunction;
}
// ********** End Class ASquareShop Function SetCurrentWheelPosition *******************************
...
struct Z_Construct_UClass_ASquareShop_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ASquareShop_SetCurrentWheelPosition, "SetCurrentWheelPosition" }, // 669297131
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Map_SquareShop_h__Script_PartyJungle_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASquareShop, ASquareShop::StaticClass, TEXT("ASquareShop"), &Z_Registration_Info_UClass_ASquareShop, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASquareShop), 2143608653U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Map_SquareShop_h__Script_PartyJungle_1137036091(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Map_SquareShop_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Map_SquareShop_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
