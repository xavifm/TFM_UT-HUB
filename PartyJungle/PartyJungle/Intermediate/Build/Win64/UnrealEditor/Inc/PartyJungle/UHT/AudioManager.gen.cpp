...
FClassRegistrationInfo Z_Registration_Info_UClass_AAudioManager;
UClass* AAudioManager::GetPrivateStaticClass()
{
	using TClass = AAudioManager;
	if (!Z_Registration_Info_UClass_AAudioManager.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AudioManager"),
			Z_Registration_Info_UClass_AAudioManager.InnerSingleton,
			StaticRegisterNativesAAudioManager,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AAudioManager.InnerSingleton;
}
UClass* Z_Construct_UClass_AAudioManager_NoRegister()
{
	return AAudioManager::GetPrivateStaticClass();
}
struct Z_Construct_UClass_AAudioManager_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AAudioManager_GetAudioTrack, "GetAudioTrack" }, // 428311096
		{ &Z_Construct_UFunction_AAudioManager_PlaySFX, "PlaySFX" }, // 2245234683
		{ &Z_Construct_UFunction_AAudioManager_PlaySong, "PlaySong" }, // 1910523898
		{ &Z_Construct_UFunction_AAudioManager_SetSFXVolume, "SetSFXVolume" }, // 1805460894
		{ &Z_Construct_UFunction_AAudioManager_SetSongVolume, "SetSongVolume" }, // 920462170
		{ &Z_Construct_UFunction_AAudioManager_StopSFX, "StopSFX" }, // 3055557180
		{ &Z_Construct_UFunction_AAudioManager_StopSong, "StopSong" }, // 4199771884
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_SoundManager_AudioManager_h__Script_PartyJungle_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AAudioManager, AAudioManager::StaticClass, TEXT("AAudioManager"), &Z_Registration_Info_UClass_AAudioManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AAudioManager), 3277302214U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_SoundManager_AudioManager_h__Script_PartyJungle_2995473323(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_SoundManager_AudioManager_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_SoundManager_AudioManager_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
