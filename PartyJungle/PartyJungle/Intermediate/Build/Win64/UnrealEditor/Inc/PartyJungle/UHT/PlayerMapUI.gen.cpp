...
// ********** Begin Class UPlayerMapUI Function SetSaveEnconomyText ********************************
struct PlayerMapUI_eventSetSaveEnconomyText_Parms
{
	int32 _crowns;
	int32 _money;
};
static FName NAME_UPlayerMapUI_SetSaveEnconomyText = FName(TEXT("SetSaveEnconomyText"));
void UPlayerMapUI::SetSaveEnconomyText(int32 _crowns, int32 _money)
{
	PlayerMapUI_eventSetSaveEnconomyText_Parms Parms;
	Parms._crowns=_crowns;
	Parms._money=_money;
	UFunction* Func = FindFunctionChecked(NAME_UPlayerMapUI_SetSaveEnconomyText);
	ProcessEvent(Func,&Parms);
}
struct Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UI" },
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::NewProp__crowns = { "_crowns", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PlayerMapUI_eventSetSaveEnconomyText_Parms, _crowns), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::NewProp__money = { "_money", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PlayerMapUI_eventSetSaveEnconomyText_Parms, _money), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::NewProp__crowns,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::NewProp__money,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UPlayerMapUI, nullptr, "SetSaveEnconomyText", Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::PropPointers), sizeof(PlayerMapUI_eventSetSaveEnconomyText_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(PlayerMapUI_eventSetSaveEnconomyText_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPlayerMapUI_SetSaveEnconomyText_Statics::FuncParams);
	}
	return ReturnFunction;
}
// ********** End Class UPlayerMapUI Function SetSaveEnconomyText **********************************
...
void UPlayerMapUI::UpdateDuelScreenInfo(int32 _coins, int32 _crowns, float _duelPercentage, int32 _team, int32 pot)
{
...
struct Z_Construct_UFunction_UPlayerMapUI_UpdateDuelScreenInfo_Statics
{
	...
	static const UECodeGen_Private::FIntPropertyParams NewProp__team;
	static const UECodeGen_Private::FIntPropertyParams NewProp_pot;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UPlayerMapUI_UpdateDuelScreenInfo_Statics::NewProp_pot = { "pot", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PlayerMapUI_eventUpdateDuelScreenInfo_Parms, pot), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPlayerMapUI_UpdateDuelScreenInfo_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPlayerMapUI_UpdateDuelScreenInfo_Statics::NewProp_pot,
};
...
// ********** Begin Class UPlayerMapUI Function UpdatePosition *************************************
struct PlayerMapUI_eventUpdatePosition_Parms
{
	int32 Team;
	int32 Position;
};
static FName NAME_UPlayerMapUI_UpdatePosition = FName(TEXT("UpdatePosition"));
void UPlayerMapUI::UpdatePosition(int32 Team, int32 Position)
{
	PlayerMapUI_eventUpdatePosition_Parms Parms;
	Parms.Team=Team;
	Parms.Position=Position;
	UFunction* Func = FindFunctionChecked(NAME_UPlayerMapUI_UpdatePosition);
	ProcessEvent(Func,&Parms);
}
struct Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UI" },
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::NewProp_Team = { "Team", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PlayerMapUI_eventUpdatePosition_Parms, Team), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PlayerMapUI_eventUpdatePosition_Parms, Position), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::NewProp_Team,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::NewProp_Position,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UPlayerMapUI, nullptr, "UpdatePosition", Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::PropPointers), sizeof(PlayerMapUI_eventUpdatePosition_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(PlayerMapUI_eventUpdatePosition_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UPlayerMapUI_UpdatePosition()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPlayerMapUI_UpdatePosition_Statics::FuncParams);
	}
	return ReturnFunction;
}
// ********** End Class UPlayerMapUI Function UpdatePosition ***************************************

// ********** Begin Class UPlayerMapUI Function UpdateUIPositions **********************************
struct Z_Construct_UFunction_UPlayerMapUI_UpdateUIPositions_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UI" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPlayerMapUI_UpdateUIPositions_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UPlayerMapUI, nullptr, "UpdateUIPositions", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPlayerMapUI_UpdateUIPositions_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPlayerMapUI_UpdateUIPositions_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UFunction_UPlayerMapUI_UpdateUIPositions()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPlayerMapUI_UpdateUIPositions_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UPlayerMapUI::execUpdateUIPositions)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->UpdateUIPositions();
	P_NATIVE_END;
}
// ********** End Class UPlayerMapUI Function UpdateUIPositions ************************************
...
void UPlayerMapUI::StaticRegisterNativesUPlayerMapUI()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "UpdateUIPositions", &UPlayerMapUI::execUpdateUIPositions },
	};
...
struct Z_Construct_UClass_UPlayerMapUI_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UPlayerMapUI_UpdatePosition, "UpdatePosition" }, // 2866414318
		{ &Z_Construct_UFunction_UPlayerMapUI_UpdateUIPositions, "UpdateUIPositions" }, // 4216824963
...
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_UI_PlayerMapUI_h__Script_PartyJungle_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPlayerMapUI, UPlayerMapUI::StaticClass, TEXT("UPlayerMapUI"), &Z_Registration_Info_UClass_UPlayerMapUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlayerMapUI), 2407991511U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_UI_PlayerMapUI_h__Script_PartyJungle_244047577(TEXT("/Script/PartyJungle"),
