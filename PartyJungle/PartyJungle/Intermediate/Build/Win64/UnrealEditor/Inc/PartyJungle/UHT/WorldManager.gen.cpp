...
// Begin Class AWorldManager Function GetCameraByIndex
struct Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics
{
	struct WorldManager_eventGetCameraByIndex_Parms
	{
		int32 _index;
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::NewProp__index = { "_index", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WorldManager_eventGetCameraByIndex_Parms, _index), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WorldManager_eventGetCameraByIndex_Parms, ReturnValue), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ReturnValue_MetaData), NewProp_ReturnValue_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::NewProp__index,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AWorldManager, nullptr, "GetCameraByIndex", nullptr, nullptr, Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::WorldManager_eventGetCameraByIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::WorldManager_eventGetCameraByIndex_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AWorldManager_GetCameraByIndex()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AWorldManager_GetCameraByIndex_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AWorldManager::execGetCameraByIndex)
{
	P_GET_PROPERTY(FIntProperty,Z_Param__index);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UCameraComponent**)Z_Param__Result=P_THIS->GetCameraByIndex(Z_Param__index);
	P_NATIVE_END;
}
// End Class AWorldManager Function GetCameraByIndex
...
void AWorldManager::StaticRegisterNativesAWorldManager()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetCameraByIndex", &AWorldManager::execGetCameraByIndex },
...
struct Z_Construct_UClass_AWorldManager_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AWorldManager_GetCameraByIndex, "GetCameraByIndex" }, // 1130873847
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AWorldManager_Statics::NewProp_Cameras_Inner = { "Cameras", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AWorldManager_Statics::NewProp_Cameras = { "Cameras", nullptr, (EPropertyFlags)0x001000800000000d, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWorldManager, Cameras), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Cameras_MetaData), NewProp_Cameras_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AWorldManager_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AWorldManager_Statics::NewProp_Cameras_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AWorldManager_Statics::NewProp_Cameras,
...
struct Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_World_WorldManager_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AWorldManager, AWorldManager::StaticClass, TEXT("AWorldManager"), &Z_Registration_Info_UClass_AWorldManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWorldManager), 1124117294U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_World_WorldManager_h_1917647139(TEXT("/Script/PartyJungle"),
