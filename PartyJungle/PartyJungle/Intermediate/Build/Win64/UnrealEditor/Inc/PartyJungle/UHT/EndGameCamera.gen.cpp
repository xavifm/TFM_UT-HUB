...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AEndGameCamera_HandleLeftRightInput_Statics::NewProp__value = { "_value", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EndGameCamera_eventHandleLeftRightInput_Parms, _value), Z_Construct_UScriptStruct_FInputActionValue, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp__value_MetaData), NewProp__value_MetaData) }; // 203218767
...
void AEndGameCamera::SwitchScoreDirection(int32 _direction)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AEndGameCamera_SwitchScoreDirection);
...
FClassRegistrationInfo Z_Registration_Info_UClass_AEndGameCamera;
UClass* AEndGameCamera::GetPrivateStaticClass()
{
	using TClass = AEndGameCamera;
	if (!Z_Registration_Info_UClass_AEndGameCamera.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EndGameCamera"),
			Z_Registration_Info_UClass_AEndGameCamera.InnerSingleton,
			StaticRegisterNativesAEndGameCamera,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AEndGameCamera.InnerSingleton;
}
UClass* Z_Construct_UClass_AEndGameCamera_NoRegister()
{
	return AEndGameCamera::GetPrivateStaticClass();
}
struct Z_Construct_UClass_AEndGameCamera_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AEndGameCamera_HandleConfirmInput, "HandleConfirmInput" }, // 3448885450
		{ &Z_Construct_UFunction_AEndGameCamera_HandleLeftRightInput, "HandleLeftRightInput" }, // 3743751436
		{ &Z_Construct_UFunction_AEndGameCamera_SwitchScoreDirection, "SwitchScoreDirection" }, // 1258860309
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_EndGame_Camera_EndGameCamera_h__Script_PartyJungle_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AEndGameCamera, AEndGameCamera::StaticClass, TEXT("AEndGameCamera"), &Z_Registration_Info_UClass_AEndGameCamera, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AEndGameCamera), 1613745266U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_EndGame_Camera_EndGameCamera_h__Script_PartyJungle_3701287520(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_EndGame_Camera_EndGameCamera_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_EndGame_Camera_EndGameCamera_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
