...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(AChallengeDatabase);
UClass* Z_Construct_UClass_AChallengeDatabase_NoRegister()
{
	return AChallengeDatabase::StaticClass();
}
struct Z_Construct_UClass_AChallengeDatabase_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AChallengeDatabase_RegisterDuel, "RegisterDuel" }, // 609633797
		{ &Z_Construct_UFunction_AChallengeDatabase_SendRegistryToInstance, "SendRegistryToInstance" }, // 1123584334
	};
...
template<> PARTYJUNGLE_API UClass* StaticClass<AChallengeDatabase>()
{
	return AChallengeDatabase::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_xavi_Documents_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Challenge_ChallengeDatabase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AChallengeDatabase, AChallengeDatabase::StaticClass, TEXT("AChallengeDatabase"), &Z_Registration_Info_UClass_AChallengeDatabase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AChallengeDatabase), 3487688815U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_xavi_Documents_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Challenge_ChallengeDatabase_h_71372559(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_xavi_Documents_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Challenge_ChallengeDatabase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_xavi_Documents_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Challenge_ChallengeDatabase_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
