...
void ADice::HideDice()
{
	UFunction* Func = FindFunctionChecked(NAME_ADice_HideDice);
...
void ADice::ShowDice()
{
	UFunction* Func = FindFunctionChecked(NAME_ADice_ShowDice);
	ProcessEvent(Func,NULL);
}
...
void ADice::ShowDiceFeedbackNumber(int32 Number)
{
	...
	Parms.Number=Number;
	UFunction* Func = FindFunctionChecked(NAME_ADice_ShowDiceFeedbackNumber);
...
void ADice::SwitchDicePosition(FVector NewPosition, bool ResizeDice)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_ADice_SwitchDicePosition);
	ProcessEvent(Func,&Parms);
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_ADice;
UClass* ADice::GetPrivateStaticClass()
{
	using TClass = ADice;
	if (!Z_Registration_Info_UClass_ADice.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("Dice"),
			Z_Registration_Info_UClass_ADice.InnerSingleton,
			StaticRegisterNativesADice,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ADice.InnerSingleton;
}
UClass* Z_Construct_UClass_ADice_NoRegister()
{
	return ADice::GetPrivateStaticClass();
}
struct Z_Construct_UClass_ADice_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DiceValue_MetaData[] = {
		{ "Category", "Dice Value" },
		{ "ModuleRelativePath", "Dice/Dice.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFloatPropertyParams NewProp_DiceFeedbackTime;
	static const UECodeGen_Private::FIntPropertyParams NewProp_DiceValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ADice_Statics::NewProp_DiceValue = { "DiceValue", nullptr, (EPropertyFlags)0x0010000000000805, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ADice, DiceValue), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DiceValue_MetaData), NewProp_DiceValue_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ADice_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ADice_Statics::NewProp_DiceValue,
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_Dice_Dice_h__Script_PartyJungle_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_Dice_Dice_h__Script_PartyJungle_1462296743(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_Dice_Dice_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_Dice_Dice_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
