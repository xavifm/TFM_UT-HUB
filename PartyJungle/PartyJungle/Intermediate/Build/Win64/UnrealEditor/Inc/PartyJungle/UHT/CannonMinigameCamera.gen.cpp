...
void ACannonMinigameCamera::SetCameraTarget(AActor* _reference)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_ACannonMinigameCamera_SetCameraTarget),&Parms);
}
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(ACannonMinigameCamera);
UClass* Z_Construct_UClass_ACannonMinigameCamera_NoRegister()
{
	return ACannonMinigameCamera::StaticClass();
}
...
template<> PARTYJUNGLE_API UClass* StaticClass<ACannonMinigameCamera>()
{
	return ACannonMinigameCamera::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_xavi_Documents_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Minigame_Minigame1_CannonMinigameCamera_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_xavi_Documents_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Minigame_Minigame1_CannonMinigameCamera_h_362393708(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_xavi_Documents_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Minigame_Minigame1_CannonMinigameCamera_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_xavi_Documents_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Minigame_Minigame1_CannonMinigameCamera_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
