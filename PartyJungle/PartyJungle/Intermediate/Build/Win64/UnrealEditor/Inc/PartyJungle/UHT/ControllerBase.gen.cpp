...
struct Z_Construct_UClass_AControllerBase_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_m_ReinitIfControllerStaysOnStateChange_MetaData[] = {
		{ "Category", "Controller" },
		{ "ModuleRelativePath", "Controllers/ControllerBase.h" },
	};
#endif // WITH_METADATA
	static void NewProp_m_ReinitIfControllerStaysOnStateChange_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_m_ReinitIfControllerStaysOnStateChange;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
void Z_Construct_UClass_AControllerBase_Statics::NewProp_m_ReinitIfControllerStaysOnStateChange_SetBit(void* Obj)
{
	((AControllerBase*)Obj)->m_ReinitIfControllerStaysOnStateChange = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AControllerBase_Statics::NewProp_m_ReinitIfControllerStaysOnStateChange = { "m_ReinitIfControllerStaysOnStateChange", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AControllerBase), &Z_Construct_UClass_AControllerBase_Statics::NewProp_m_ReinitIfControllerStaysOnStateChange_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_m_ReinitIfControllerStaysOnStateChange_MetaData), NewProp_m_ReinitIfControllerStaysOnStateChange_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AControllerBase_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AControllerBase_Statics::NewProp_m_ReinitIfControllerStaysOnStateChange,
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_Controllers_ControllerBase_h__Script_PartyJungle_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AControllerBase, AControllerBase::StaticClass, TEXT("AControllerBase"), &Z_Registration_Info_UClass_AControllerBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AControllerBase), 567157173U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_Controllers_ControllerBase_h__Script_PartyJungle_70623652(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_Controllers_ControllerBase_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PartyJungle_Source_PartyJungle_Controllers_ControllerBase_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
