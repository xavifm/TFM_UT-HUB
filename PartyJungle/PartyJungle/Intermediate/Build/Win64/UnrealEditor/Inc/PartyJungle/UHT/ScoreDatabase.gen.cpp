...
FClassRegistrationInfo Z_Registration_Info_UClass_AScoreDatabase;
UClass* AScoreDatabase::GetPrivateStaticClass()
{
	using TClass = AScoreDatabase;
	if (!Z_Registration_Info_UClass_AScoreDatabase.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("ScoreDatabase"),
			Z_Registration_Info_UClass_AScoreDatabase.InnerSingleton,
			StaticRegisterNativesAScoreDatabase,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AScoreDatabase.InnerSingleton;
}
UClass* Z_Construct_UClass_AScoreDatabase_NoRegister()
{
	return AScoreDatabase::GetPrivateStaticClass();
}
struct Z_Construct_UClass_AScoreDatabase_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AScoreDatabase_AddTransactionToRegistry, "AddTransactionToRegistry" }, // 774205877
		{ &Z_Construct_UFunction_AScoreDatabase_GetScore, "GetScore" }, // 3261123116
		{ &Z_Construct_UFunction_AScoreDatabase_GetScoresArray, "GetScoresArray" }, // 1351203700
		{ &Z_Construct_UFunction_AScoreDatabase_SendTransactionsAndScoresToInstance, "SendTransactionsAndScoresToInstance" }, // 3848209343
		{ &Z_Construct_UFunction_AScoreDatabase_UpdateCrowns, "UpdateCrowns" }, // 2460291037
		{ &Z_Construct_UFunction_AScoreDatabase_UpdateGlobalPositions, "UpdateGlobalPositions" }, // 4157414773
		{ &Z_Construct_UFunction_AScoreDatabase_UpdateTotalCoins, "UpdateTotalCoins" }, // 1174999764
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Scores_ScoreDatabase_h__Script_PartyJungle_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AScoreDatabase, AScoreDatabase::StaticClass, TEXT("AScoreDatabase"), &Z_Registration_Info_UClass_AScoreDatabase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AScoreDatabase), 927336113U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Scores_ScoreDatabase_h__Script_PartyJungle_1807470087(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Scores_ScoreDatabase_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Scores_ScoreDatabase_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
