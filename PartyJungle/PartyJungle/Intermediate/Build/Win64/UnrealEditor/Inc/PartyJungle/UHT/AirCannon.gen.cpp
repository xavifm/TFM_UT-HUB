...
struct Z_Construct_UClass_AAirCannon_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RamrodPressed_MetaData[] = {
		{ "Category", "AirCannon" },
		{ "ModuleRelativePath", "Minigame/Minigame1/AirCannon.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_IsCannonCharging_MetaData[] = {
		{ "Category", "AirCannon" },
		{ "ModuleRelativePath", "Minigame/Minigame1/AirCannon.h" },
	};
	...
	static void NewProp_RamrodPressed_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_RamrodPressed;
	static void NewProp_IsCannonCharging_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_IsCannonCharging;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AAirCannon_CalculateCurrentPushStrength, "CalculateCurrentPushStrength" }, // 1958489531
...
void Z_Construct_UClass_AAirCannon_Statics::NewProp_RamrodPressed_SetBit(void* Obj)
{
	((AAirCannon*)Obj)->RamrodPressed = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAirCannon_Statics::NewProp_RamrodPressed = { "RamrodPressed", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAirCannon), &Z_Construct_UClass_AAirCannon_Statics::NewProp_RamrodPressed_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RamrodPressed_MetaData), NewProp_RamrodPressed_MetaData) };
void Z_Construct_UClass_AAirCannon_Statics::NewProp_IsCannonCharging_SetBit(void* Obj)
{
	((AAirCannon*)Obj)->IsCannonCharging = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAirCannon_Statics::NewProp_IsCannonCharging = { "IsCannonCharging", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AAirCannon), &Z_Construct_UClass_AAirCannon_Statics::NewProp_IsCannonCharging_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IsCannonCharging_MetaData), NewProp_IsCannonCharging_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AAirCannon_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAirCannon_Statics::NewProp_RamrodPressed,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAirCannon_Statics::NewProp_IsCannonCharging,
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Minigame_Minigame1_AirCannon_h__Script_PartyJungle_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Minigame_Minigame1_AirCannon_h__Script_PartyJungle_807892476(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Minigame_Minigame1_AirCannon_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Minigame_Minigame1_AirCannon_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
