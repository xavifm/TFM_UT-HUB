...
FClassRegistrationInfo Z_Registration_Info_UClass_UTransactionDto;
UClass* UTransactionDto::GetPrivateStaticClass()
{
	using TClass = UTransactionDto;
	if (!Z_Registration_Info_UClass_UTransactionDto.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("TransactionDto"),
			Z_Registration_Info_UClass_UTransactionDto.InnerSingleton,
			StaticRegisterNativesUTransactionDto,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UTransactionDto.InnerSingleton;
}
UClass* Z_Construct_UClass_UTransactionDto_NoRegister()
{
	return UTransactionDto::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Scores_TransactionDto_h__Script_PartyJungle_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTransactionDto, UTransactionDto::StaticClass, TEXT("UTransactionDto"), &Z_Registration_Info_UClass_UTransactionDto, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTransactionDto), 4019025936U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Scores_TransactionDto_h__Script_PartyJungle_2481492540(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Scores_TransactionDto_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_Scores_TransactionDto_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
