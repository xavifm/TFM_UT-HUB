...
void UEndGameUI::AddChallengeToList(UChallengeDto* _challenge, bool _debug)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UEndGameUI_AddChallengeToList);
...
void UEndGameUI::AddScoreToList(UScoreDto* _score, bool _winner)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UEndGameUI_AddScoreToList);
	ProcessEvent(Func,&Parms);
}
...
void UEndGameUI::AddTransactionToList(UTransactionDto* _transaction, bool _debug)
{
	...
	Parms._debug=_debug ? true : false;
	UFunction* Func = FindFunctionChecked(NAME_UEndGameUI_AddTransactionToList);
	ProcessEvent(Func,&Parms);
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEndGameUI_InitializeRegistry_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UEndGameUI, nullptr, "InitializeRegistry", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEndGameUI_InitializeRegistry_Statics::Function_MetaDataParams), Z_Construct_UFunction_UEndGameUI_InitializeRegistry_Statics::Function_MetaDataParams)},  };
...
void UEndGameUI::SwitchScoreList(bool _enabled)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UEndGameUI_SwitchScoreList);
	ProcessEvent(Func,&Parms);
}
...
void UEndGameUI::SwitchScoreType(int32 _direction)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UEndGameUI_SwitchScoreType);
	ProcessEvent(Func,&Parms);
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEndGameUI_SwitchScoreType_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UEndGameUI, nullptr, "SwitchScoreType", Z_Construct_UFunction_UEndGameUI_SwitchScoreType_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UEndGameUI_SwitchScoreType_Statics::PropPointers), sizeof(EndGameUI_eventSwitchScoreType_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEndGameUI_SwitchScoreType_Statics::Function_MetaDataParams), Z_Construct_UFunction_UEndGameUI_SwitchScoreType_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UEndGameUI;
UClass* UEndGameUI::GetPrivateStaticClass()
{
	using TClass = UEndGameUI;
	if (!Z_Registration_Info_UClass_UEndGameUI.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("EndGameUI"),
			Z_Registration_Info_UClass_UEndGameUI.InnerSingleton,
			StaticRegisterNativesUEndGameUI,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UEndGameUI.InnerSingleton;
}
UClass* Z_Construct_UClass_UEndGameUI_NoRegister()
{
	return UEndGameUI::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UEndGameUI_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UEndGameUI_AddChallengeToList, "AddChallengeToList" }, // 2201966440
		{ &Z_Construct_UFunction_UEndGameUI_AddScoreToList, "AddScoreToList" }, // 2566418529
		{ &Z_Construct_UFunction_UEndGameUI_AddTransactionToList, "AddTransactionToList" }, // 1959225896
		{ &Z_Construct_UFunction_UEndGameUI_InitializeRegistry, "InitializeRegistry" }, // 787496166
		{ &Z_Construct_UFunction_UEndGameUI_StartChallengeList, "StartChallengeList" }, // 658326088
		{ &Z_Construct_UFunction_UEndGameUI_StartScoreList, "StartScoreList" }, // 3805421359
		{ &Z_Construct_UFunction_UEndGameUI_SwitchScoreList, "SwitchScoreList" }, // 292313859
		{ &Z_Construct_UFunction_UEndGameUI_SwitchScoreType, "SwitchScoreType" }, // 1956309727
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_UI_EndGameUI_h__Script_PartyJungle_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEndGameUI, UEndGameUI::StaticClass, TEXT("UEndGameUI"), &Z_Registration_Info_UClass_UEndGameUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEndGameUI), 90127662U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_UI_EndGameUI_h__Script_PartyJungle_988965849(TEXT("/Script/PartyJungle"),
	Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_UI_EndGameUI_h__Script_PartyJungle_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Unreal_Projects_TFM_UT_HUB_PartyJungle_PartyJungle_Source_PartyJungle_Player_UI_EndGameUI_h__Script_PartyJungle_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
